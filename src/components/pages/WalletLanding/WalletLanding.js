                ...
                <Col xs={{ offset: 1, span: 22 }} md={{ offset: 5, span: 7 }} lg={{ offset: 4, span: 8 }}>
                  <Row className='walletSelect div-wrap'>
                    <Col className='div-relative'>
                      ...
                      <Row className='wallet-detail header'>{t('Access your existing MGL wallet here')}</Row>
                      <Row className='wallet-detail wallet-button'>
                        <Col span={24}>
                          <Button className='access-button' onClick={accessWallet}>
                            {t('ACCESS WALLET')}
                          </Button>
                        </Col>
                      </Row>
                ...
                <Col xs={{ span: 22 }} md={{ offset: 0, span: 7 }} lg={{ offset: 0, span: 8 }}>
                  <Row className='walletSelect div-wrap'>
                    <Col className='div-relative'>
                      ...
                      <Row className='wallet-detail header'>{t('Create a new wallet to trade assets.')}</Row>
                      <Row className='wallet-detail wallet-button'>
                        <Col span={24}>
                          <Button className='create-button' onClick={createWallet}>
                            {t('CREATE NEW WALLET')}
                          </Button>
                        </Col>
                      </Row>
              ...
              <Row>
                ...
                >
                  <Row>
                    ...
                    <Col span={24} className='text-center'>
                      <Button className='genkey-button' onClick={generatePhrase}>
                ...
                <Col xs={{ offset: 1, span: 22 }} md={{ offset: 5, span: 7 }} lg={{ offset: 2, span: 10 }}>
                  <Row className='div-wrap'>
                    <Col span={24}>
                        ...
                        <Col span={24}>
                          <Row gutter={[6, 6]} className='walletSelect'>
                            {mnemonic.split(' ').map((item, idx) => (
                              <Col span={8} key={idx}>
                                <div className='keyphrase'>{`${idx + 1}. ${item}`}</div>
                              </Col>
                            ))}
                          </Row>
                        </Col>
                      ...
                      <Row className='wallet-detail wallet-button'>
                        <Col span={24}>
                          <Button className='access-button' onClick={regeneratePhrase}>
                            {t('REGENERATE')}
                          </Button>
                        </Col>
                      </Row>
                ...
                <Col xs={{ span: 22 }} md={{ offset: 0, span: 7 }} lg={{ offset: 0, span: 10 }}>
                  <Row className='walletSelect div-wrap'>
                    <Col className='div-relative'>
                      ...
                      <Row className='wallet-detail header'>{t('This is your key phrase.')}</Row>
                      <Row className='text-grey wallet-detail' style={{ fontSize: 18 }}>
                      ...
                      <Row className='wallet-detail' style={{ color: 'rgb(134, 126, 137)', fontWeight: '700' }}>
                        {!verify ? (
                          <>
                            <div style={{ color: 'red' }}>{t('ATTENTION!')}</div>
                            {t(
                      ...
                      <Row className='wallet-detail wallet-button'>
                        <Col span={24}>
                          {verify ? (
                            <Button className='access-button  mt-2' onClick={completeCreation}>
                              {t('ACCESS WALLET')}
                            </Button>
                          ) : (
                            <Button className='use-button' onClick={() => verifyModal()}>
                              {t('ACCESS WALLET')}
                            </Button>
                          )}
                        </Col>
