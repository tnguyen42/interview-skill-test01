...
function WalletManageKeys(props) {
  ...
  return (
    <>
      ...
      {contentModal ? <WalletAlert content={content} setModalShow={setContentModal} title={contentType.title} /> : null}
      {passwordModal ? <WalletInputModal confirm={confirmPassword} setModalShow={setPasswordModal} /> : null}
    </>
  );
}
