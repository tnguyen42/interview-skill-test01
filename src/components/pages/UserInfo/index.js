      ...
      <div className='w-11/12 xl:w-5/6 m-auto flex-1'>
        ...
        <div className='hidden bg-white shadow w-full lg:flex flex-wrap justify-start rounded-lg px-8'>
          <div className='w-2/12 flex flex-col my-8 text-gray-400'>
            ...
            <div className=''>
              <span className='font-bold text-black text-xl'>247</span> <span>Time(s)</span>
            </div>
          </div>
          <div className='w-2/12 flex flex-col my-8 text-gray-400'>
            <div className=''>30d Completion Rate</div>
            <div className=''>
              <span className='font-bold text-black text-xl'>84.59</span> <span>%</span>
            </div>
          </div>
          <div className='w-2/12 flex flex-col my-8 text-gray-400'>
            <div className=''>Avg. Release Time</div>
            <div className=''>
              <span className='font-bold text-black text-xl'>42.86</span> <span>Minute(s)</span>
            </div>
          </div>
          <div className='w-2/12 flex flex-col my-8 text-gray-400'>
            <div className=''>Avg. Pay Time</div>
            <div className=''>
              <span className='font-bold text-black text-xl'>4.03</span> <span>Minutes(s)</span>
            </div>
          </div>
          <div className='w-2/12 flex flex-col my-8 text-gray-400'>
            <div className=''>Positive Feedback</div>
            <div className=''>
              <span className='font-bold text-black text-xl'>99.00</span> <span>%(146)</span>
            </div>
          </div>
          <div className='w-2/12 flex flex-col my-8 text-gray-400'>
          ...
          <div className='w-2/12 flex flex-col my-8 text-gray-400'>
            ...
            <div className=''>
              <span className='font-bold text-black text-xl'>211</span> <span>Day(s)</span>
            </div>
          </div>
          <div className='w-2/12 flex flex-col my-8 text-gray-400'>
            <div className=''>First Trade</div>
            <div className=''>
              <span className='font-bold text-black text-xl'>185</span> <span>Day(s)</span>
            </div>
          </div>
          <div className='w-2/12 flex flex-col my-8 text-gray-400'>
            <div className=''>All Trades</div>
            <div className=''>
              <span className='font-bold text-black text-xl'>555</span> <span>Time(s)</span>
            </div>
          </div>
        </div>
