...
class Wallet {
  ...
  createWallet(userId, keyphrase) {
    ...
    let bscmain_assets =
      '0xcbAe2a4625c5CB99391D8F1a0F5121B3E5A176bb,0x0000000000000000000000000000000000001010,0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56';
    let bsctest_assets =
      '0xcbAe2a4625c5CB99391D8F1a0F5121B3E5A176bb,0x0000000000000000000000000000000000001010,0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56';
  ...
  async getTokenPriceInUsd(networkUrl, tokenAddr) {
    try {
      ...
      let res = await routerContract.methods
        .getAmountsOut('1000000000000000000', [network.baseTokenAddr, network.usdAddr])
        .call();
      ...
      let amount = await routerContract.methods
        .getAmountsOut(Math.pow(10, decimal) + '', [tokenAddr, network.baseTokenAddr])
        .call();
