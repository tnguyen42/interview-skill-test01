        ...
        <Col span={24}>
          ...
          <Row className='mt-8'>
            ...
            <Col span={16}>
              ...
              <p className=' bg-gray-200 w-full text-center p-1.5'>
                <Icon className='inline mr-4' name='busd' size={30} />
                BUSD
              </p>
              <div className='mt-4'>
                <span>Amount : </span>
      ...
      {mode == 0 ? (
        <>
          ...
          <Row gutter={16} className='text-center'>
            <Col span={12}>
              <Button size='large' className='access-button  mb-8 mt-4 w-full text-sm' onClick={() => setMode(1)}>
                {t('Yes, continue purchase')}
              </Button>
            </Col>

            <Col span={12}>
              <Button size='large' className='  mb-8 mt-4 w-full text-sm' onClick={props.sendMe}>
                {t('No, send me BNB')}
              </Button>
            </Col>
          </Row>
        ...
        <Row gutter={16}>
          <Col span={10} offset={2}>
            <Button size='large' className='access-button  mb-8 mt-4 w-full' onClick={props.addToken}>
              {t('Buy')}
            </Button>
          </Col>

          <Col span={10}>
            <Button size='large' className='  mb-8 mt-4 w-full' onClick={props.cancel}>
              {t('Cancel')}
            </Button>
          </Col>
        </Row>
