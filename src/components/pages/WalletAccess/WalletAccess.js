                  ...
                  <Col className='div-relative' span={24}>
                    ...
                    <Row gutter={[16, 8]} className='wallet-button text-center'>
                      <Col xs={{ offset: 1, span: 22 }} md={{ offset: 7, span: 10 }} className='text-center'>
                        <Button className='access-button' onClick={accessWalletWithPrivateKey}>
                          {t('ACCESS WALLET')}
                        </Button>
                      </Col>
              ...
              <Col xs={{ offset: 1, span: 22 }} md={{ offset: 1, span: 22 }}>
                <Row gutter={[6, 6]} className='wallet-detail'>
                  ...
                  <Col xs={{ span: 24 }} lg={{ span: 12 }}>
                    <Row gutter={[6, 6]} className='walletSelect div-wrap'>
                      <Col span={24}>
                        <div className='header'>{t('Enter your MNEMONIC phrase')}</div>
                        <div className='text-grey'>{t('Hit ‘SPACE’ after every successful word entry.')}</div>
                      </Col>
                      <Col span={24}>
                        <TextArea
                          rows={6}
                      ...
                      <Col>
                        <Button className='access-button' style={{ marginTop: 10 }} onClick={accessWalletWithKeyphrase}>
                          {t('ACCESS WALLET')}
                        </Button>
                      </Col>
